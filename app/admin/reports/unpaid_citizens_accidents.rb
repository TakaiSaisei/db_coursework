ActiveAdmin.register_page 'Unpaid Citizen accidents' do

  menu label: "Unpaid Citizen accidents", parent: "Reports"

  content title: "Unpaid Citizen accidents report" do
    panel "Top 10" do
      query = "SELECT citizens.first_name || ' ' || citizens.middle_name || ' ' || citizens.second_name as Citizen,
                ...
                WHERE penalties.payed = 0 GROUP BY citizens.id
